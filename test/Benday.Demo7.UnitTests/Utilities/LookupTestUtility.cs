...
namespace Benday.Demo7.UnitTests.Utilities
{
    ...
    {
        public static List<Benday.Demo7.Api.DataAccess.Entities.LookupEntity> CreateEntities(
            bool createAsUnsaved = true, bool onlyScalarProperties = true)
        {
            var returnValues = new List<Benday.Demo7.Api.DataAccess.Entities.LookupEntity>();
        ...
        public static Benday.Demo7.Api.DataAccess.Entities.LookupEntity CreateEntity(
            bool onlyScalarProperties = false
            )
        {
            var fromValue = new Benday.Demo7.Api.DataAccess.Entities.LookupEntity
            {
        ...
        public static Benday.Demo7.Api.DomainModels.Lookup CreateModel(
            bool createAsUnsaved = true)
        {
            var fromValue = new Benday.Demo7.Api.DomainModels.Lookup
            {
                DisplayOrder = UnitTestUtility.GetFakeValueForInt("DisplayOrder"),
                LookupType = UnitTestUtility.GetFakeValueForString("LookupType"),
                LookupKey = UnitTestUtility.GetFakeValueForString("LookupKey"),
        ...
        public static List<Benday.Demo7.Api.DomainModels.Lookup> CreateModels(
        ...
        public static void AssertAreEqual(
            ...
            IList<Benday.Demo7.Api.DataAccess.Entities.LookupEntity> actual)
        {
        ...
        public static void AssertAreEqual(
            ...
            Benday.Demo7.Api.DataAccess.Entities.LookupEntity actual)
        {
        ...
        public static void AssertAreEqual(
            IList<Benday.Demo7.Api.DataAccess.Entities.LookupEntity> expected,
