...
namespace Benday.Demo7.UnitTests.Utilities
{
    ...
    {
        public static List<Benday.Demo7.Api.DataAccess.Entities.FeedbackEntity> CreateEntities(
            bool createAsUnsaved = true, bool onlyScalarProperties = true)
        {
            var returnValues = new List<Benday.Demo7.Api.DataAccess.Entities.FeedbackEntity>();
        ...
        public static Benday.Demo7.Api.DataAccess.Entities.FeedbackEntity CreateEntity(
            bool onlyScalarProperties = false
            )
        {
            var fromValue = new Benday.Demo7.Api.DataAccess.Entities.FeedbackEntity
            {
        ...
        public static Benday.Demo7.Api.DomainModels.Feedback CreateModel(
            bool createAsUnsaved = true)
        {
            var fromValue = new Benday.Demo7.Api.DomainModels.Feedback
            {
                FeedbackType = UnitTestUtility.GetFakeValueForString("FeedbackType"),
                Sentiment = UnitTestUtility.GetFakeValueForString("Sentiment"),
                Subject = UnitTestUtility.GetFakeValueForString("Subject"),
        ...
        public static List<Benday.Demo7.Api.DomainModels.Feedback> CreateModels(
            bool createAsUnsaved = true, int numberOfRecords = 10)
        {
            var returnValues = new List<Benday.Demo7.Api.DomainModels.Feedback>();
        ...
        public static void AssertAreEqual(
            ...
            IList<Benday.Demo7.Api.DataAccess.Entities.FeedbackEntity> actual)
        {
        ...
        public static void AssertAreEqual(
            ...
            Benday.Demo7.Api.DataAccess.Entities.FeedbackEntity actual)
        {
        ...
        public static void AssertAreEqual(
            IList<Benday.Demo7.Api.DataAccess.Entities.FeedbackEntity> expected,
