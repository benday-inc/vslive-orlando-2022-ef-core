...
using Benday.Demo7.WebUi.Controllers;
using Benday.Demo7.WebUi.Models;
using Benday.Demo7.UnitTests.ViewModels;
using Benday.Demo7.Api;
using Benday.Common;



namespace Benday.Demo7.UnitTests.MvcControllers
{
    [TestClass]
    public class ConfigurationItemControllerFixture
    {
        ...
        private Benday.Demo7.WebUi.Controllers.ConfigurationItemController _systemUnderTest;
        
        private Benday.Demo7.WebUi.Controllers.ConfigurationItemController SystemUnderTest
        {
            get
            {
                ...
                {
                    _systemUnderTest =
                        new Benday.Demo7.WebUi.Controllers.ConfigurationItemController(
