...
namespace Benday.Demo7.UnitTests.Adapters
{
    ...
    public class ConfigurationItemAdapterFixture
    {
        ...
        private static void AssertValuesStillExistAndIdDidNotChange(
            List<Benday.Demo7.Api.DomainModels.ConfigurationItem> actualValues,
            Dictionary<int, Benday.Demo7.Api.DomainModels.ConfigurationItem> expectedValuesById)
        {
        ...
        private static Dictionary<int, Benday.Demo7.Api.DomainModels.ConfigurationItem> GetOriginalValuesById(
            List<Benday.Demo7.Api.DomainModels.ConfigurationItem> values)
        {
            var originalValuesById =
                new Dictionary<int, Benday.Demo7.Api.DomainModels.ConfigurationItem>();
        ...
        public void AdaptConfigurationItemFromModelToEntity()
        {
            ...
            var toValue = new Benday.Demo7.Api.DataAccess.Entities.ConfigurationItemEntity();
        ...
        public void AdaptConfigurationItemFromModelsToEntities_ToEmpty()
        {
            ...
            var toValues = new List<Benday.Demo7.Api.DataAccess.Entities.ConfigurationItemEntity>();
        ...
        private static void AssertValuesStillExistAndIdDidNotChange(
            List<Benday.Demo7.Api.DataAccess.Entities.ConfigurationItemEntity> actualValues,
            Dictionary<int, Benday.Demo7.Api.DataAccess.Entities.ConfigurationItemEntity> expectedValuesById)
        {
            Assert.AreEqual<int>(expectedValuesById.Count, actualValues.Count, "Item count changed.");
        ...
        private static Dictionary<int, Benday.Demo7.Api.DataAccess.Entities.ConfigurationItemEntity> GetOriginalValuesById(
            List<Benday.Demo7.Api.DataAccess.Entities.ConfigurationItemEntity> values)
        {
            var originalValuesById =
                new Dictionary<int, Benday.Demo7.Api.DataAccess.Entities.ConfigurationItemEntity>();
