...
namespace Benday.Demo7.UnitTests.Adapters
{
    ...
    public class PersonAdapterFixture
    {
        ...
        private static void AssertValuesStillExistAndIdDidNotChange(
            List<Benday.Demo7.Api.DomainModels.Person> actualValues,
            Dictionary<int, Benday.Demo7.Api.DomainModels.Person> expectedValuesById)
        {
        ...
        private static Dictionary<int, Benday.Demo7.Api.DomainModels.Person> GetOriginalValuesById(
            List<Benday.Demo7.Api.DomainModels.Person> values)
        {
            var originalValuesById =
                new Dictionary<int, Benday.Demo7.Api.DomainModels.Person>();
        ...
        public void AdaptPersonFromModelToEntity()
        {
            ...
            var toValue = new Benday.Demo7.Api.DataAccess.Entities.PersonEntity();
        ...
        public void AdaptPersonFromModelsToEntities_ToEmpty()
        {
            ...
            var toValues = new List<Benday.Demo7.Api.DataAccess.Entities.PersonEntity>();
        ...
        private static void AssertValuesStillExistAndIdDidNotChange(
            List<Benday.Demo7.Api.DataAccess.Entities.PersonEntity> actualValues,
            Dictionary<int, Benday.Demo7.Api.DataAccess.Entities.PersonEntity> expectedValuesById)
        {
            Assert.AreEqual<int>(expectedValuesById.Count, actualValues.Count, "Item count changed.");
        ...
        private static Dictionary<int, Benday.Demo7.Api.DataAccess.Entities.PersonEntity> GetOriginalValuesById(
            List<Benday.Demo7.Api.DataAccess.Entities.PersonEntity> values)
        {
            var originalValuesById =
                new Dictionary<int, Benday.Demo7.Api.DataAccess.Entities.PersonEntity>();
