...
namespace Benday.Demo7.UnitTests.Adapters
{
    ...
    public class UserClaimAdapterFixture
    {
        ...
        public void AdaptUserClaimFromEntityToModel()
        {
            ...
            var toValue = new Benday.Demo7.Api.DomainModels.UserClaim();
        ...
        public void AdaptUserClaimFromEntitiesToModels_ToEmpty()
        {
            ...
            var toValues = new List<Benday.Demo7.Api.DomainModels.UserClaim>();
        ...
        private static void AssertValuesStillExistAndIdDidNotChange(
            List<Benday.Demo7.Api.DomainModels.UserClaim> actualValues,
            Dictionary<int, Benday.Demo7.Api.DomainModels.UserClaim> expectedValuesById)
        {
        ...
        private static Dictionary<int, Benday.Demo7.Api.DomainModels.UserClaim> GetOriginalValuesById(
            List<Benday.Demo7.Api.DomainModels.UserClaim> values)
        {
            var originalValuesById =
                new Dictionary<int, Benday.Demo7.Api.DomainModels.UserClaim>();
        ...
        public void AdaptUserClaimFromModelToEntity()
        {
            ...
            var toValue = new Benday.Demo7.Api.DataAccess.Entities.UserClaimEntity();
        ...
        public void AdaptUserClaimFromModelsToEntities_ToEmpty()
        {
            ...
            var toValues = new List<Benday.Demo7.Api.DataAccess.Entities.UserClaimEntity>();
        ...
        private static void AssertValuesStillExistAndIdDidNotChange(
            List<Benday.Demo7.Api.DataAccess.Entities.UserClaimEntity> actualValues,
            Dictionary<int, Benday.Demo7.Api.DataAccess.Entities.UserClaimEntity> expectedValuesById)
        {
            Assert.AreEqual<int>(expectedValuesById.Count, actualValues.Count, "Item count changed.");
        ...
        private static Dictionary<int, Benday.Demo7.Api.DataAccess.Entities.UserClaimEntity> GetOriginalValuesById(
            List<Benday.Demo7.Api.DataAccess.Entities.UserClaimEntity> values)
        {
            var originalValuesById =
                new Dictionary<int, Benday.Demo7.Api.DataAccess.Entities.UserClaimEntity>();
