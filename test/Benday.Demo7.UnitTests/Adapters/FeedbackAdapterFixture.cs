...
namespace Benday.Demo7.UnitTests.Adapters
{
    ...
    public class FeedbackAdapterFixture
    {
        ...
        private static void AssertValuesStillExistAndIdDidNotChange(
            List<Benday.Demo7.Api.DomainModels.Feedback> actualValues,
            Dictionary<int, Benday.Demo7.Api.DomainModels.Feedback> expectedValuesById)
        {
        ...
        private static Dictionary<int, Benday.Demo7.Api.DomainModels.Feedback> GetOriginalValuesById(
            List<Benday.Demo7.Api.DomainModels.Feedback> values)
        {
            var originalValuesById =
                new Dictionary<int, Benday.Demo7.Api.DomainModels.Feedback>();
        ...
        public void AdaptFeedbackFromModelToEntity()
        {
            ...
            var toValue = new Benday.Demo7.Api.DataAccess.Entities.FeedbackEntity();
        ...
        public void AdaptFeedbackFromModelsToEntities_ToEmpty()
        {
            ...
            var toValues = new List<Benday.Demo7.Api.DataAccess.Entities.FeedbackEntity>();
        ...
        private static void AssertValuesStillExistAndIdDidNotChange(
            List<Benday.Demo7.Api.DataAccess.Entities.FeedbackEntity> actualValues,
            Dictionary<int, Benday.Demo7.Api.DataAccess.Entities.FeedbackEntity> expectedValuesById)
        {
            Assert.AreEqual<int>(expectedValuesById.Count, actualValues.Count, "Item count changed.");

            Benday.Demo7.Api.DataAccess.Entities.FeedbackEntity expected;
        ...
        private static Dictionary<int, Benday.Demo7.Api.DataAccess.Entities.FeedbackEntity> GetOriginalValuesById(
            List<Benday.Demo7.Api.DataAccess.Entities.FeedbackEntity> values)
        {
            var originalValuesById =
                new Dictionary<int, Benday.Demo7.Api.DataAccess.Entities.FeedbackEntity>();
