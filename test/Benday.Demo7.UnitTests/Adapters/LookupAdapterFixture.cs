...
namespace Benday.Demo7.UnitTests.Adapters
{
    ...
    public class LookupAdapterFixture
    {
        ...
        private static void AssertValuesStillExistAndIdDidNotChange(
            List<Benday.Demo7.Api.DomainModels.Lookup> actualValues,
            Dictionary<int, Benday.Demo7.Api.DomainModels.Lookup> expectedValuesById)
        {
        ...
        private static Dictionary<int, Benday.Demo7.Api.DomainModels.Lookup> GetOriginalValuesById(
            List<Benday.Demo7.Api.DomainModels.Lookup> values)
        {
            var originalValuesById =
                new Dictionary<int, Benday.Demo7.Api.DomainModels.Lookup>();
        ...
        public void AdaptLookupFromModelToEntity()
        {
            ...
            var toValue = new Benday.Demo7.Api.DataAccess.Entities.LookupEntity();
        ...
        public void AdaptLookupFromModelsToEntities_ToEmpty()
        {
            ...
            var toValues = new List<Benday.Demo7.Api.DataAccess.Entities.LookupEntity>();
        ...
        private static void AssertValuesStillExistAndIdDidNotChange(
            List<Benday.Demo7.Api.DataAccess.Entities.LookupEntity> actualValues,
            Dictionary<int, Benday.Demo7.Api.DataAccess.Entities.LookupEntity> expectedValuesById)
        {
            Assert.AreEqual<int>(expectedValuesById.Count, actualValues.Count, "Item count changed.");

            Benday.Demo7.Api.DataAccess.Entities.LookupEntity expected;
        ...
        private static Dictionary<int, Benday.Demo7.Api.DataAccess.Entities.LookupEntity> GetOriginalValuesById(
            List<Benday.Demo7.Api.DataAccess.Entities.LookupEntity> values)
        {
            var originalValuesById =
                new Dictionary<int, Benday.Demo7.Api.DataAccess.Entities.LookupEntity>();
