...
namespace Benday.Demo7.Api.DataAccess.SqlServer
{
    public partial class SqlEntityFrameworkPersonRepository :
        SqlEntityFrameworkSearchableRepositoryBase<PersonEntity, Demo7DbContext>,
        IPersonRepository
    {
        ...
        protected override IQueryable<PersonEntity> AddDefaultSort(IQueryable<PersonEntity> query)
        {
            ...
            SearchArgument arg)
        {
            ...
            else
            {
                ...
                else if (arg.PropertyName == nameof(PersonEntity.Id) && arg.Method != SearchMethod.Skip && int.TryParse(arg.SearchValue, out _) == true)
                {
        ...
        {
            if (string.Compare(propertyName, "FirstName", true) == 0)
            {
                if (isFirstSort == true)
                {
