...
namespace Benday.Demo7.Api.DataAccess.SqlServer
{
    public partial class SqlEntityFrameworkUserRepository :
        SqlEntityFrameworkSearchableRepositoryBase<UserEntity, Demo7DbContext>,
        IUserRepository
    {
            ...
            SearchArgument arg)
        {
            ...
            else
            {
                ...
                else if (arg.PropertyName == nameof(UserEntity.Id) && arg.Method != SearchMethod.Skip && int.TryParse(arg.SearchValue, out _) == true)
                {
