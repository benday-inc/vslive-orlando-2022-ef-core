...
namespace Benday.Demo7.Api.DataAccess.SqlServer
{
    public partial class SqlEntityFrameworkUserClaimRepository :
        SqlEntityFrameworkSearchableRepositoryBase<UserClaimEntity, Demo7DbContext>,
        IUserClaimRepository
    {
            ...
            SearchArgument arg)
        {
            ...
            else
            {
                ...
                else if (arg.PropertyName == nameof(UserClaimEntity.ClaimValue))
                {
                    return q => q.ClaimValue == arg.SearchValue;
                }
                else if (arg.PropertyName == nameof(UserClaimEntity.UserId) && arg.Method != SearchMethod.Skip && int.TryParse(arg.SearchValue, out _) == true)
                {
                    return q => q.UserId == int.Parse(arg.SearchValue);
                }
                else if (arg.PropertyName == nameof(UserClaimEntity.ClaimLogicType))
                {
                    return q => q.ClaimLogicType == arg.SearchValue;
                }
                else if (arg.PropertyName == nameof(UserClaimEntity.Id) && arg.Method != SearchMethod.Skip && int.TryParse(arg.SearchValue, out _) == true)
                {
