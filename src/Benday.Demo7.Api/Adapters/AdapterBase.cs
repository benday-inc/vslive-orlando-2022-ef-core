...
namespace Benday.Demo7.Api.Adapters
{
        ...
        where TType2 : class, IInt32Identity, IDeleteable, new()
    {
        public virtual void Adapt(
            TType1 fromValue,
            TType2 toValue, bool onlyScalarProperties = false)
        {
            ...
            if (action == AdapterActions.Adapt)
            {
                ...
                {
                    PerformAdapt(fromValue, toValue, true);
                }
        ...
        public virtual void Adapt(
            TType2 fromValue,
            TType1 toValue, bool onlyScalarProperties = false)
        {
            var action = BeforeAdapt(fromValue, toValue);
        ...
        protected virtual void PerformAdapt(
            TType1 fromValue,
            TType2 toValue, bool onlyScalarProperties)
        {
        ...
        protected virtual void PerformAdapt(
            TType2 fromValue,
            TType1 toValue, bool onlyScalarProperties)
        {
            throw new NotImplementedException();
        }
