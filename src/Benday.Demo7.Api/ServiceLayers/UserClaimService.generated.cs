...
namespace Benday.Demo7.Api.ServiceLayers
{
    public partial class UserClaimService :
        CoreFieldsServiceLayerBase<Benday.Demo7.Api.DomainModels.UserClaim>,
        IUserClaimService
    {
        private IUserClaimRepository _Repository;
        private UserClaimAdapter _Adapter;
        private IValidatorStrategy<Benday.Demo7.Api.DomainModels.UserClaim> _ValidatorInstance;
        private ISearchStringParserStrategy _SearchStringParser;
        
        public UserClaimService(
            IUserClaimRepository repository,
            IValidatorStrategy<Benday.Demo7.Api.DomainModels.UserClaim> validator,
        ...
        public IList<Benday.Demo7.Api.DomainModels.UserClaim> GetAll(
        ...
        public Benday.Demo7.Api.DomainModels.UserClaim GetById(int id)
        {
            ...
            {
                var returnValue = new Benday.Demo7.Api.DomainModels.UserClaim();
        ...
        public void Save(Benday.Demo7.Api.DomainModels.UserClaim saveThis)
        {
            if (saveThis == null)
            ...
            {
                Benday.Demo7.Api.DataAccess.Entities.UserClaimEntity toValue;
                
                if (saveThis.Id == 0)
                {
                    toValue = new Benday.Demo7.Api.DataAccess.Entities.UserClaimEntity();
                }
                else
                {
            ...
            int maxNumberOfResults = 100)
        {
            ...
            if (searchTypeUserId == SearchMethod.Equals)
            {
                foundOneNonNullSearchValue = true;
                search.AddArgument(
                    "UserId", searchTypeUserId, searchValueUserId);
            }
        ...
        public IList<Benday.Demo7.Api.DomainModels.UserClaim> Search(Search search)
        {
            var returnValues = new List<Benday.Demo7.Api.DomainModels.UserClaim>();
