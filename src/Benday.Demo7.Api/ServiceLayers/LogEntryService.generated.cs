...
namespace Benday.Demo7.Api.ServiceLayers
{
    public partial class LogEntryService :
        ServiceLayerBase<Benday.Demo7.Api.DomainModels.LogEntry>,
        ILogEntryService
    {
        private ILogEntryRepository _Repository;
        private LogEntryAdapter _Adapter;
        private IValidatorStrategy<Benday.Demo7.Api.DomainModels.LogEntry> _ValidatorInstance;
        private ISearchStringParserStrategy _SearchStringParser;
        
        public LogEntryService(
            ILogEntryRepository repository,
            IValidatorStrategy<Benday.Demo7.Api.DomainModels.LogEntry> validator,
        ...
        public IList<Benday.Demo7.Api.DomainModels.LogEntry> GetAll(
        ...
        public Benday.Demo7.Api.DomainModels.LogEntry GetById(int id)
        {
            ...
            {
                var returnValue = new Benday.Demo7.Api.DomainModels.LogEntry();
        ...
        public void Save(Benday.Demo7.Api.DomainModels.LogEntry saveThis)
        {
            if (saveThis == null)
            ...
            {
                Benday.Demo7.Api.DataAccess.Entities.LogEntryEntity toValue;
                
                if (saveThis.Id == 0)
                {
                    toValue = new Benday.Demo7.Api.DataAccess.Entities.LogEntryEntity();
                }
                else
                {
        ...
        public IList<Benday.Demo7.Api.DomainModels.LogEntry> Search(Search search)
        {
            var returnValues = new List<Benday.Demo7.Api.DomainModels.LogEntry>();
