...
namespace Benday.Demo7.Api.ServiceLayers
{
    public partial class FeedbackService :
        CoreFieldsServiceLayerBase<Benday.Demo7.Api.DomainModels.Feedback>,
        IFeedbackService
    {
        private IFeedbackRepository _Repository;
        private FeedbackAdapter _Adapter;
        private IValidatorStrategy<Benday.Demo7.Api.DomainModels.Feedback> _ValidatorInstance;
        private ISearchStringParserStrategy _SearchStringParser;
        
        public FeedbackService(
            IFeedbackRepository repository,
            IValidatorStrategy<Benday.Demo7.Api.DomainModels.Feedback> validator,
        ...
        public IList<Benday.Demo7.Api.DomainModels.Feedback> GetAll(
        ...
        public Benday.Demo7.Api.DomainModels.Feedback GetById(int id)
        {
            ...
            {
                var returnValue = new Benday.Demo7.Api.DomainModels.Feedback();
        ...
        public void Save(Benday.Demo7.Api.DomainModels.Feedback saveThis)
        {
            if (saveThis == null)
            ...
            {
                Benday.Demo7.Api.DataAccess.Entities.FeedbackEntity toValue;
                
                if (saveThis.Id == 0)
                {
                    toValue = new Benday.Demo7.Api.DataAccess.Entities.FeedbackEntity();
                }
                else
                {
        ...
        public IList<Benday.Demo7.Api.DomainModels.Feedback> Search(Search search)
        {
            var returnValues = new List<Benday.Demo7.Api.DomainModels.Feedback>();
