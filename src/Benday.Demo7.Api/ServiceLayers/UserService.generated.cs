...
namespace Benday.Demo7.Api.ServiceLayers
{
    public partial class UserService :
        CoreFieldsServiceLayerBase<Benday.Demo7.Api.DomainModels.User>,
        IUserService
    {
        private IUserRepository _Repository;
        private UserAdapter _Adapter;
        private IValidatorStrategy<Benday.Demo7.Api.DomainModels.User> _ValidatorInstance;
        private ISearchStringParserStrategy _SearchStringParser;
        
        public UserService(
            IUserRepository repository,
            IValidatorStrategy<Benday.Demo7.Api.DomainModels.User> validator,
        ...
        public IList<Benday.Demo7.Api.DomainModels.User> GetAll(
        ...
        public Benday.Demo7.Api.DomainModels.User GetById(int id)
        {
            ...
            {
                var returnValue = new Benday.Demo7.Api.DomainModels.User();
        ...
        public void Save(Benday.Demo7.Api.DomainModels.User saveThis)
        {
            if (saveThis == null)
            ...
            {
                Benday.Demo7.Api.DataAccess.Entities.UserEntity toValue;
                
                if (saveThis.Id == 0)
                {
                    toValue = new Benday.Demo7.Api.DataAccess.Entities.UserEntity();
                }
                else
                {
        ...
        public IList<Benday.Demo7.Api.DomainModels.User> Search(Search search)
        {
            var returnValues = new List<Benday.Demo7.Api.DomainModels.User>();
