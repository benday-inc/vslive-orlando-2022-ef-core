...
namespace Benday.Demo7.Api.ServiceLayers
{
    public partial class ConfigurationItemService :
        CoreFieldsServiceLayerBase<Benday.Demo7.Api.DomainModels.ConfigurationItem>,
        IConfigurationItemService
    {
        private IConfigurationItemRepository _Repository;
        private ConfigurationItemAdapter _Adapter;
        private IValidatorStrategy<Benday.Demo7.Api.DomainModels.ConfigurationItem> _ValidatorInstance;
        ...
        public ConfigurationItemService(
            ...
            IValidatorStrategy<Benday.Demo7.Api.DomainModels.ConfigurationItem> validator,
        ...
        public IList<Benday.Demo7.Api.DomainModels.ConfigurationItem> GetAll(
        ...
        public Benday.Demo7.Api.DomainModels.ConfigurationItem GetById(int id)
        {
            ...
            {
                var returnValue = new Benday.Demo7.Api.DomainModels.ConfigurationItem();
        ...
        public void Save(Benday.Demo7.Api.DomainModels.ConfigurationItem saveThis)
        {
            if (saveThis == null)
            ...
            {
                Benday.Demo7.Api.DataAccess.Entities.ConfigurationItemEntity toValue;
                
                if (saveThis.Id == 0)
                {
                    toValue = new Benday.Demo7.Api.DataAccess.Entities.ConfigurationItemEntity();
                }
                else
                {
        ...
        public IList<Benday.Demo7.Api.DomainModels.ConfigurationItem> SimpleSearch(
            string searchValue,
            string sortBy = null,
        ...
        public IList<Benday.Demo7.Api.DomainModels.ConfigurationItem> Search(
        ...
        public IList<Benday.Demo7.Api.DomainModels.ConfigurationItem> Search(Search search)
        {
            var returnValues = new List<Benday.Demo7.Api.DomainModels.ConfigurationItem>();
