...
@Component({
  selector: 'app-user-claim-search',
  templateUrl: './user-claim-search.component.html',
  styleUrls: ['./user-claim-search.component.css'],
})
export class UserClaimSearchComponent implements OnInit {
  public searchValue: string = ApplicationConstants.emptySearchValue;
  public items: SimpleSearchResults<UserClaim> =
    new SimpleSearchResults<UserClaim>();
  ...
  constructor(private service: UserClaimService, private router: Router) {}
  ...
  load() {
    if (this.autoLoad === true) {
      ...
      this.items = new SimpleSearchResults<UserClaim>();
      this.message = ApplicationConstants.emptyMessage;
    }
  }
  ...
  private handleSearchResults(data: SimpleSearchResults<UserClaim>) {
    this.items = data;
